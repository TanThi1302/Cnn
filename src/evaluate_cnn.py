...
# Tải trọng số đã lưu
model_path = 'model/cnn_lung_disease_model.pth'
...
with open("training_results.txt", "w") as f:
    ...
    for epoch in range(num_epochs):
        ...
        # Tính thời gian cho epoch
        epoch_time = time.time() - start_time
        
        # In và lưu kết quả
        result = (f"Epoch {epoch+1}/{num_epochs}, "
...
# Lưu mô hình
torch.save(model.state_dict(), 'model/cnn_lung_disease_model_retrained.pth')
print("Model saved to model/cnn_lung_disease_model_retrained.pth")
